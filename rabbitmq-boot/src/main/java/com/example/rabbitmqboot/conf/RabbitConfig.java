package com.example.rabbitmqboot.conf;

import com.example.rabbitmqboot.RmConst;
import com.example.rabbitmqboot.hello.UserReceiver;
import lombok.Data;
...
public class RabbitConfig {
    ...
    //================以下是topic Exchange================
    @Bean
    public Queue    queueEmailMessage(){return  new Queue(RmConst.QUEUE_TOPIC_EMAIL);}
    ...
    //申明队列
    @Bean
    public Queue  AMessage(){return new Queue("sb.fanout.A");}
